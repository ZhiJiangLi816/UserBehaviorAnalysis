...
object NetworkFlow {
  def main(args: Array[String]): Unit = {
    ...
    val dataStream = env.readTextFile("H:\\workspace\\ideaDemo\\SparkWorkSpace\\UserBehaviorAnalysis\\NetworkFlowAnalysis\\src\\main\\resources\\apache.log")
      .map(data => {
