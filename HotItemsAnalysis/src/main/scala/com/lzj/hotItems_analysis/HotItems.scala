...
object HotItems {
  def main(args: Array[String]): Unit = {
    ...
    // 2.读取数据
    //val dataStream = env.readTextFile("H:\\workspace\\ideaDemo\\SparkWorkSpace\\UserBehaviorAnalysis\\HotItemsAnalysis\\src\\main\\resources\\UserBehavior.csv")
